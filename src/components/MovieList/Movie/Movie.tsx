  ...
  return (
    <>
      {isLoading ? (
        ...
        <div className="w-imgList md:mr-4 xs:mr-0 py-10 relative mt-8">
          <div>
            ...
            <div className="flex items-center flex-col">
              <h2 className="w-full text-xl text-white p-2 whitespace-nowrap overflow-hidden overflow-ellipsis text-center">
                {title}
              </h2>
