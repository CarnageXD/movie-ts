...
export const SearchBy: React.FC<TrendMoviesType> = () => {
    ...
    const onSearchClicked = () => {
        axios.get(`https://api.themoviedb.org/3/search/movie?api_key=4b8235a2493fa47038f86ca8c6056b47&language=en&query=${searchMovie}&page=${currentPage}`).then(resp => {
